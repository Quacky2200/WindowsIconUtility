...
namespace WindowsIconUtility
{
    ...
    public class IconFile
    {
        ...
        public GRPICONDIRENTRY Header { get; }
        public IconTypeHint TypeHint { get; }
        public byte[] Data { get; }
        public uint DataLen { get; }

        public IconFile(string origin, Windows.GRPICONDIRENTRY header, IconTypeHint typeHint, byte[] data, uint dataLen)
        {
            this.Origin = origin;
            this.Header = header;
